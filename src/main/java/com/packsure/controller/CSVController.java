...
public class CSVController {
    ...
    public ResponseEntity<?> uploadCSVFile(@RequestParam("file") MultipartFile file) {
        ...
        try {
            ...
            Map<String , List<PaymentInfo>> savedInfos = paymentInfoService.processAndReport(paymentInfos);
    ...
    @GetMapping("/by-date")
    public ResponseEntity<Map<String, List<PaymentInfo>>> getReportByDate(
